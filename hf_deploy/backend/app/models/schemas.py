...
# --- Fix H-8: Strict Pydantic model for scenario parameters ---
class ScenarioParams(BaseModel):
    price_change: float = Field(default=0, ge=-100, le=100)
    volume_change: float = Field(default=0, ge=-100, le=100)
