            ...
            for idx, row in df.iterrows():
                ...
                if value < lower_bound or value > upper_bound:
                    ...
                    anomalies.append({
                        ...
                        'description': f"AI detected {anomaly_type} on {date_str}: {abs(pct_change):.1f}% {'increase' if value > mean_val else 'decrease'}"
                    })
            ...
            for idx, row in df.iterrows():
                ...
                if z_score > threshold:
                    ...
                    anomalies.append({
                        ...
                        'description': f"AI detected {anomaly_type} on {date_str}: {abs(pct_change):.1f}% change"
                    })
